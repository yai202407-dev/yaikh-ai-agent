...
export const NotebookSidebar: React.FC<NotebookSidebarProps> = ({ isOpen, onClose, onToolClick, activeDeckTools = [] }) => {
    ...
    return (
        <div className={`border-l border-white/5 bg-[#010409] flex flex-col h-full shadow-2xl relative z-20 shrink-0 transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? 'w-80' : 'w-0'}`}>
